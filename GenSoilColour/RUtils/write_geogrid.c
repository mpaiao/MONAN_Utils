/* File: write_geogrid.c
   ...
   Slightly modified by Marcos Longo (INPE) so it works with R.
*/
...
int write_geogrid(
      double * darray,       /* The array to be written, in double precision */
      int * ixa_in,          /* first index of the x-dimension of the array */
      int * iya_in,          /* first index of the y-dimension of the array */
      int * ixz_in,          /* last index of the x-dimension of the array */
      int * iyz_in,          /* last index of the y-dimension of the array */
      int * nx_in,           /* x-dimension of the array */
      int * ny_in,           /* y-dimension of the array */
      int * nz_in,           /* z-dimension of the array */
      int * isigned_in,      /* 0=unsigned data, 1=signed data */
      int * endian_in,       /* 0=big endian, 1=little endian */
      int * wordsize_in )    /* number of bytes to use for each array element */
{
   int i, narray;
   int A2, B2;
   int A3, B3, C3;
   ...
   ny       = ny_in [0];
   nz       = nz_in [0];
   isigned  = isigned_in[0];
   endian   = endian_in[0];
   wordsize = wordsize_in[0];
   ...
   for (i=0; i<narray; i++){
      iarray[i] = (unsigned int)(darray[i]);
   }
   ...
   */
   ...
   sprintf(fname,"%5.5i-%5.5i.%5.5i-%5.5i",ixa,ixz,iya,iyz);
